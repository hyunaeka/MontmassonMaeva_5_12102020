...
//--------------------------- Récupération des données pour le panier et affichage de la structure -----------------------------------


function displayChoiceCustomer() {
  if (saveCart == null) {
...
if (saveCart == null) {
  ...
  // ------------  Création de la structure et affichage  -------------
  ...
  btnSendForm.addEventListener("click", (e) => {
    ...
    if (
      firstNameControl() && lastNameControl() && cityControl() && zipCodeControl() && emailControl() && addressControl()
    ) {
